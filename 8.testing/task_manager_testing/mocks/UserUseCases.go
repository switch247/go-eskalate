...
// CreateUsers provides a mock function with given fields: c, user
func (_m *UserUseCases) CreateUsers(c *gin.Context, user *Domain.User) (Domain.OmitedUser, error, int) {
...
// DeleteUsersById provides a mock function with given fields: c, id, user
func (_m *UserUseCases) DeleteUsersById(c *gin.Context, id primitive.ObjectID, user Domain.OmitedUser) (error, int) {
...
// GetUsersById provides a mock function with given fields: c, id, user
func (_m *UserUseCases) GetUsersById(c *gin.Context, id primitive.ObjectID, user Domain.OmitedUser) (Domain.OmitedUser, error, int) {
	ret := _m.Called(c, id, user)
	...
	var r1 error
	var r2 int
	if rf, ok := ret.Get(0).(func(*gin.Context, primitive.ObjectID, Domain.OmitedUser) (Domain.OmitedUser, error, int)); ok {
		return rf(c, id, user)
	}
	if rf, ok := ret.Get(0).(func(*gin.Context, primitive.ObjectID, Domain.OmitedUser) Domain.OmitedUser); ok {
		r0 = rf(c, id, user)
	} else {
		r0 = ret.Get(0).(Domain.OmitedUser)
	}
...
// UpdateUsersById provides a mock function with given fields: c, id, user, curentuser
func (_m *UserUseCases) UpdateUsersById(c *gin.Context, id primitive.ObjectID, user Domain.User, curentuser Domain.OmitedUser) (Domain.OmitedUser, error, int) {
	ret := _m.Called(c, id, user, curentuser)
	...
	var r1 error
	var r2 int
	if rf, ok := ret.Get(0).(func(*gin.Context, primitive.ObjectID, Domain.User, Domain.OmitedUser) (Domain.OmitedUser, error, int)); ok {
		return rf(c, id, user, curentuser)
	}
	if rf, ok := ret.Get(0).(func(*gin.Context, primitive.ObjectID, Domain.User, Domain.OmitedUser) Domain.OmitedUser); ok {
		r0 = rf(c, id, user, curentuser)
	} else {
		r0 = ret.Get(0).(Domain.OmitedUser)
	}

	if rf, ok := ret.Get(1).(func(*gin.Context, primitive.ObjectID, Domain.User, Domain.OmitedUser) error); ok {
		r1 = rf(c, id, user, curentuser)
	} else {
		r1 = ret.Error(1)
	}

	if rf, ok := ret.Get(2).(func(*gin.Context, primitive.ObjectID, Domain.User, Domain.OmitedUser) int); ok {
		r2 = rf(c, id, user, curentuser)
	} else {
		r2 = ret.Get(2).(int)
	}
